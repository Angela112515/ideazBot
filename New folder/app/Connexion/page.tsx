...
import { Lock, User, Lightbulb, Sparkles } from "lucide-react";
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="backdrop-blur-lg bg-white/80 rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 p-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-3xl font-bold text-white mb-2">IdeazBot</h1>
                <p className="text-purple-100 text-sm font-medium tracking-wider">
                  INSPIRE · DEVELOP · ENGAGE · ACHIEVE
                </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/60 backdrop-blur-sm border border-purple-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/80"
                  ...
                  >
                    <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                      {loading ? (
                        ...
                        <Lock className="h-5 w-5 text-purple-200 group-hover:text-purple-100 transition-colors duration-200" />
                      )}
                    </span>
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <a href="/Inscription" className="font-medium text-purple-600 hover:text-purple-500 transition-colors duration-200">
                      S'inscrire
                    </a>
                  </p>
                </div>
          ...
          <div className="text-center">
            <p className="text-purple-700/80 text-sm italic backdrop-blur-sm bg-white/30 rounded-2xl p-4 border border-white/40">
              ...
              <span className="block text-xs mt-1 text-purple-600/70">- Steve Jobs</span>
            </p>
          </div>
        </div>
      </div>
